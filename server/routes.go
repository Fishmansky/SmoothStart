...
func (s *SmoothStartServer) Routes() {
	...
	admin.GET("/team/memberplan/:id", auth.Validate(adminHandler.ShowMemberPlan), auth.IsAdmin)
	admin.PUT("/team/memberplan/addstep", auth.Validate(adminHandler.AddPlanStep), auth.IsAdmin)
	admin.POST("/team/memberplan/editstep", auth.Validate(adminHandler.GetEditPlanStep), auth.IsAdmin)
	admin.PUT("/team/memberplan/editstep", auth.Validate(adminHandler.EditPlanStep), auth.IsAdmin)
